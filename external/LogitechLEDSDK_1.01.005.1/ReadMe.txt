...
for changing lighting on compatible Logitech gaming mice and keyboards.


Contents of the package
--------------------------------------------------------------------------

- Logitech Gaming Led SDK header, libs and dlls, 32 and 64 bit
- Demo executable
- Documentation
...
Execute Demo/LEDSliders.exe.

Or:

1. Go to Samples/LEDSliders folder and open the project in
   Visual Studio (LEDSLiders.sln for VS2010, LEDSLiders2008.sln for
   VS2008).
...
- Lib\x86\LogitechLed.lib and Lib\x86\LogitechLed.dll or
- Lib\x64\LogitechLed.lib and Lib\x64\LogitechLed.dll

3. Alternatively you may only add the LogitechLed.dll to your game and use
   GetProcAddress to access its functions.

4. Read and follow instructions from Doc/LogitechGamingLEDSDK.pdf
